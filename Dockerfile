...
FROM docker.io/elasticms/base-apache-fpm:7.4 AS ems-prod
...
FROM docker.io/elasticms/base-apache-dev:7.4 AS ems-dev
...
LABEL eu.elasticms.admin.build-date=$BUILD_DATE_ARG \
      ...
      eu.elasticms.admin.release="$RELEASE_ARG" \
      eu.elasticms.admin.schema-version="1.0" \
      eu.elasticms.admin.docker-image="all-in-one-dev"
